...
- **Next checkpoint:** CP 1.6 — Juice pass 1 (bloom, particles, shake, hit-stop)
- **Phase:** 1 — The Toy
- **Last updated:** 2026-06-13 (CP 1.5 build + tests done, self-certified — Ludo waived the CP 1.5/1.6 human playtests. CP 1.4 swarm-surf playtest still pending Ludo; CP 1.2 + 1.3 signed off)
